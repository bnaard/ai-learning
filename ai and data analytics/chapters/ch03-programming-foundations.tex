...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \begin{tblr}{|Q[l,m,3cm]|X|}
        ...
        \hline
        \texttt{dataclasses.dataclass}   & Auto-generates \texttt{\_\_init\_\_}, \texttt{\_\_repr\_\_} from annotated fields \\
        \hline
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \begin{tblr}{|Q[l,m,4.5cm]|X|}
        ...
        \hline
        \texttt{df.groupby("region").agg(\{"sales": "sum", "profit": "mean"\})} & Multiple agg functions per column \\
        \hline
        \texttt{df.groupby("region")["sales"].transform("mean")} & Broadcast group mean back to original index \\
        \hline
