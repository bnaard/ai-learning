...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=What is an Agent?, raster multicolumn=3]
    ...
    \tcbitem[title=Multi-Agent System (MAS), raster multicolumn=3]
    ...
    \tcbitem[title=Environment Types, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Application Domains, raster multicolumn=4]
    ...
    \tcbitem[title=Why MAS?, raster multicolumn=2]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=BDI Architecture, raster multicolumn=3]
    ...
    \tcbitem[title=FIPA Standards, raster multicolumn=3]
    ...
    \tcbitem[title=Agent-Oriented Methodologies, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Symbolic Reasoning Agents, raster multicolumn=3]
    ...
    \tcbitem[title={Planning: STRIPS \& PDDL}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title={Subsumption Architecture (Brooks)}, raster multicolumn=3]
    ...
    \tcbitem[title=Reactive vs.\ Deliberative, raster multicolumn=3]
    \begin{tblr}{
        colspec={X[l]X[l]},
        hlines, vlines,
        row{1}={font=\bfseries\small, bg=LimeGreen!20},
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Layered Hybrid Architectures, raster multicolumn=3]
    ...
    \tcbitem[title=InteRRaP Architecture, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Ontologies in MAS, raster multicolumn=3]
    ...
    \tcbitem[title=Knowledge Representation Levels, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Speech Act Theory, raster multicolumn=3]
    ...
    \tcbitem[title={FIPA-ACL Message Structure}, raster multicolumn=3]
    ...
    \tcbitem[title=Interaction Protocols, raster multicolumn=6]
    ...
    \begin{tblr}{
        ...
        FIPA Request & Initiator $\to$ PROPOSE $\to$ Participant; AGREE/REFUSE back & Simple service invocation \\
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Task Decomposition and Sharing, raster multicolumn=3]
    ...
    \tcbitem[title=Blackboard Systems, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Coordination and Inconsistency, raster multicolumn=3]
    ...
    \tcbitem[title=Asynchronous Teams, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Bargaining and Monotonic Concession, raster multicolumn=3]
    ...
    \tcbitem[title=Argumentation-Based Negotiation, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Normal-Form Games, raster multicolumn=3]
    ...
    \tcbitem[title=Nash Equilibrium, raster multicolumn=3]
    ...
    \tcbitem[title={Dominant Strategies \& Pareto Optimality}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Voting Mechanisms, raster multicolumn=3]
    ...
    \tcbitem[title=Coalition Formation and Shapley Value, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Auction Types, raster multicolumn=4]
    ...
    \tcbitem[title=Mechanism Design, raster multicolumn=2]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=The Non-Stationarity Problem, raster multicolumn=3]
    ...
    \tcbitem[title={Centralised Training, Decentralised Execution (CTDE)}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Value Decomposition: QMIX, raster multicolumn=3]
    ...
    \tcbitem[title=MADDPG and MAPPO, raster multicolumn=3]
    ...
    \tcbitem[title={Cooperative vs.\ Competitive vs.\ Mixed}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=StarCraft and AlphaStar, raster multicolumn=3]
    ...
    \tcbitem[title={Multi-Robot Coordination \& Traffic}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Supply Chain Coordination, raster multicolumn=3]
    ...
    \tcbitem[title=Production Scheduling, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Agent-Based Manufacturing and JADE, raster multicolumn=3]
    ...
    \tcbitem[title=Holonic Manufacturing Systems, raster multicolumn=3]
