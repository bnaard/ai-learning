...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Healthcare Stakeholders}, raster multicolumn=6]
    ...
    \tcbitem[title={Digital Health Transformation}, raster multicolumn=3]
    ...
    \tcbitem[title={Electronic Health Records (EHR)}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Traditional Drug Discovery Pipeline}, raster multicolumn=6]
    ...
    \tcbitem[title={Virtual Screening and Molecular Graphs}, raster multicolumn=3]
    ...
    \tcbitem[title={Generative Molecular Design}, raster multicolumn=3]
    ...
    \tcbitem[title={{AlphaFold: Protein Structure Prediction}}, raster multicolumn=6]
    ...
    \tcbitem[title={ADMET Prediction}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Precision Medicine}, raster multicolumn=3]
    ...
    \tcbitem[title={Pharmacogenomics}, raster multicolumn=3]
    ...
    \tcbitem[title={Digital Twins in Healthcare}, raster multicolumn=3]
    ...
    \tcbitem[title={Clinical Decision Support Systems}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={X-Ray and Computed Tomography}, raster multicolumn=3]
    ...
    \tcbitem[title={Magnetic Resonance Imaging (MRI)}, raster multicolumn=3]
    ...
    \tcbitem[title={PET and Ultrasound}, raster multicolumn=3]
    ...
    \tcbitem[title={Modality Comparison}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Classification: Skin Cancer and Retinopathy}, raster multicolumn=6]
    ...
    \tcbitem[title={Object Detection in Medical Images}, raster multicolumn=3]
    ...
    \tcbitem[title={U-Net: Segmentation for Medical Images}, raster multicolumn=3]
    ...
    \tcbitem[title={Image Registration}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Annotation Challenges}, raster multicolumn=3]
    ...
    \tcbitem[title={Radiologist-AI Collaboration}, raster multicolumn=3]
    ...
    \tcbitem[title={Regulatory Approval: FDA and CE}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Medical Terminologies and Coding}, raster multicolumn=6]
    ...
    \tcbitem[title={Clinical Text Characteristics}, raster multicolumn=3]
    ...
    \tcbitem[title={De-identification and Privacy}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Named Entity Recognition for Clinical Text}, raster multicolumn=3]
    ...
    \tcbitem[title={Clinical Summarisation}, raster multicolumn=3]
    ...
    \tcbitem[title={Medical Chatbots and Diagnostic Support}, raster multicolumn=3]
    ...
    \tcbitem[title={NLP in Radiology Reports}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Wearables and Remote Monitoring}, raster multicolumn=3]
    ...
    \tcbitem[title={IoMT Cybersecurity}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Robotic-Assisted Surgery: da Vinci System}, raster multicolumn=6]
    ...
    \tcbitem[title={Navigation and Image Registration in Surgery}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Health Data Sensitivity and GDPR}, raster multicolumn=3]
    ...
    \begin{itemize}
        ...
        \item \textbf{DPA}: Data Protection Impact Assessment mandatory for high-risk AI health applications.
    \end{itemize}

    \tcbitem[title={Federated Learning for Healthcare}, raster multicolumn=3]
    ...
    \tcbitem[title={Privacy-Preserving ML Techniques}, raster multicolumn=6]
    \begin{tblr}{|Q[l,m,2.5cm]|X[l]|X[l]|}
        \hline
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Sources of Bias in Healthcare AI}, raster multicolumn=3]
    ...
    \tcbitem[title={Racial Identity in Medical Images}, raster multicolumn=3]
    ...
    \tcbitem[title={Fairness Metrics and Regulation}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Why Explainability Matters in Healthcare}, raster multicolumn=3]
    ...
    \tcbitem[title={{Grad-CAM for Medical Images}}, raster multicolumn=3]
    ...
    \tcbitem[title={{LIME and SHAP in Clinical AI}}, raster multicolumn=3]
    ...
    \tcbitem[title={Responsible AI Deployment Checklist}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title=Recommended Sources for AI in Healthcare and Medical Imaging, raster multicolumn=6]
    \begin{itemize}
