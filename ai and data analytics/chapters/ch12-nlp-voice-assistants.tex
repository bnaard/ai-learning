...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \end{itemize}
    \textbf{Vocabulary size trade-off}: larger vocabulary $\to$ more tokens, richer encoding, but larger model and memory footprint.
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \begin{itemize}
        ...
        \item \textbf{Naive Bayes}: fast discriminative text classifier;
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \end{equation}
    This is simply next-token prediction on large unlabelled
