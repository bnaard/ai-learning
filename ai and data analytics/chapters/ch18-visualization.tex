...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Anscombe's Quartet}, raster multicolumn=3]
    ...
    \tcbitem[title={Pre-attentive Processing and Cognitive Load}, raster multicolumn=3]
    ...
    \tcbitem[title={Data-Ink Ratio (Tufte)}, raster multicolumn=3]
    ...
    \tcbitem[title={Exploratory vs.\ Explanatory Visualization}, raster multicolumn=3]
    \begin{tblr}{|X[l]|X[l]|}
        \hline
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Marks and Channels}, raster multicolumn=3]
    ...
    \tcbitem[title={Cleveland \& McGill Effectiveness Ranking}, raster multicolumn=3]
    ...
    \tcbitem[title={Gestalt Principles in Chart Design}, raster multicolumn=6]
    The Gestalt principles describe how humans group visual elements automatically:
    \begin{tblr}{|X[l,1]|X[l,3]|X[l,2]|}
        \hline
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Colour Palette Types}, raster multicolumn=3]
    ...
    \tcbitem[title={Perceptual Uniformity and Colourblind Safety}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Bar and Column Charts}, raster multicolumn=3]
    ...
    \tcbitem[title={Histograms and Density Plots}, raster multicolumn=3]
    ...
    \tcbitem[title={Box Plots and Violin Plots}, raster multicolumn=3]
    ...
    \tcbitem[title={When to Use Which Distribution Chart}, raster multicolumn=3]
    \begin{tblr}{|X[l]|X[l]|}
        \hline
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Scatter Plots and Bubble Charts}, raster multicolumn=3]
    ...
    \tcbitem[title={Heatmaps and Correlation Matrices}, raster multicolumn=3]
    ...
    \tcbitem[title={Pair Plots (Scatterplot Matrix)}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Pie Charts and When to Avoid Them}, raster multicolumn=3]
    ...
    \tcbitem[title={Line Charts and Time Series}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Confusion Matrix}, raster multicolumn=3]
    ...
    \tcbitem[title={ROC Curve and AUC}, raster multicolumn=3]
    ...
    \tcbitem[title={Precision-Recall Curve}, raster multicolumn=3]
    ...
    \tcbitem[title={Learning Curves}, raster multicolumn=3]
    ...
    \tcbitem[title={Feature Importance Plots}, raster multicolumn=3]
    ...
    \tcbitem[title={SHAP Summary Plots}, raster multicolumn=3]
    ...
    \tcbitem[title={t-SNE and UMAP Embedding Plots}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Few's Dashboard Design Principles}, raster multicolumn=3]
    ...
    \tcbitem[title={KPIs and Layout Patterns}, raster multicolumn=3]
    ...
    \tcbitem[title={Common Dashboard Anti-Patterns}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Narrative Structure in Data Presentations}, raster multicolumn=3]
    ...
    \tcbitem[title={Annotation, Context, and Audience Design}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Matplotlib: The Foundation}, raster multicolumn=3]
    ...
    \tcbitem[title={Seaborn: Statistical Plots}, raster multicolumn=3]
    ...
    \tcbitem[title={Plotly: Interactive Visualization}, raster multicolumn=3]
    ...
    \tcbitem[title={Altair: Declarative Visualization}, raster multicolumn=3]
    ...
    \tcbitem[title={Streamlit and Dash: Dashboard Frameworks}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Tableau and Power BI}, raster multicolumn=3]
    ...
    \tcbitem[title={D3.js and ggplot2}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Recommended Sources for Visualization}, raster multicolumn=6]
    \begin{itemize}
