...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \begin{tblr}{colspec={|X|X|}, hlines}
        ...
        Model-based (MICE) & Multiple Imputation by Chained Equations; gold standard for MNAR \\
    \end{tblr}
\end{tcbitemize}
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title={Correlation Matrix \& Correlation $\neq$ Causation}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \begin{enumerate}
        ...
        \item \textbf{Eigendecompose}: $\mathbf{C} = \mathbf{V}\mathbf{\Lambda}\mathbf{V}^\top$; columns of $\mathbf{V}$ are principal directions
