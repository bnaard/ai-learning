...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \begin{itemize}
        \item \textbf{Box filter}: uniform kernel; fast mean blur, but introduces ringing artefacts.
        \item \textbf{Gaussian}: smooth, isotropic; no ringing; $\sigma$ controls blur radius.
