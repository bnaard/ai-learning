...
\begin{multicols}{2}[
    ...
    \begin{tcbitemize}[ skin=sectionraster ]
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \captionof{figure}{Graph of $y = x^2$ with tangent line at point $P(1,1)$. The tangent's gradient is defined by angle $\alpha$, known as the angle of inclination of the tangent line.}\label{fig:derivative}
    ...
    \begin{tcbitemize}[ skin=sectionraster ]
        ...
        \tcbitem[title=Angle, raster multicolumn=6]
        ...
        \tcbitem[title=Cosine similarity, raster multicolumn=6]
