...
all\textsuperscript{\cite{gerlachBeyondMultiplyAccumulate2026}}.
...
Take $d = 4{,}096$, $N = 32$ layers, $V = 32{,}000$, untied embeddings. Since
...
attention, and it helps to see them
together\textsuperscript{\cite{gerlachBeyondMultiplyAccumulate2026}}.
...
answer has changed
recently\textsuperscript{\cite{gerlachBeyondMultiplyAccumulate2026}}.
...
Layer normalisation & \emph{was yes} & Integer mean and variance; the square
  root by iterative shift-and-add \\
