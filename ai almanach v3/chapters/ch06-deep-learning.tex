...
\chapterlead{How do layered differentiable models learn representations at scale?}{Represent}{Differentiate}{Optimise}{Scale}{deep-learning}
...
\begin{v3topic}{The Biological Neuron}
...
\end{v3topic}
\begin{v3topic}{From Biology to Computation}
...
\end{v3topic}
\begin{v3topic}{The XOR Problem and MLPs}
...
\end{v3topic}
\begin{v3topic}{From Perceptrons to Deep Learning}
...
\begin{v3topic}{Why Activation Functions Matter}
...
\end{v3topic}
\begin{v3topic}{ReLU: The Default Choice}
...
\end{v3topic}
\begin{v3topic}{Softmax for Classification}
...
\end{v3topic}
\begin{v3topic}{Universal Approximation}
...
\begin{v3topic}{The Convolution Operation}
...
\end{v3topic}
\begin{v3topic}{Pooling and Feature Hierarchies}
...
\end{v3topic}
\begin{v3topic}{Landmark CNN Architectures}
\visualseparator
...
\begin{v3topic}{Recurrent Neural Networks}
...
\end{v3topic}
\begin{v3topic}{LSTM: Long Short-Term Memory}
...
\end{v3topic}
\begin{v3topic}{GRU: Gated Recurrent Unit}
...
\begin{v3topic}{The Forward Pass}
...
\end{v3topic}
\begin{v3topic}{Common Loss Functions}
\visualseparator
...
\begin{v3topic}{Why Initialization Matters}
...
\end{v3topic}
\begin{v3topic}{Xavier and He Initialization}
...
\end{v3topic}
\begin{v3topic}{Gradient Descent Variants}
...
\end{v3topic}
\begin{v3topic}{Mini-Batch Gradient Descent}
...
\begin{v3topic}{Epochs and Batches}
...
\end{v3topic}
\begin{v3topic}{Data Splits and Early Stopping}
...
\end{v3topic}
\begin{v3topic}{Weight Regularisation}
...
\end{v3topic}
\begin{v3topic}{Batch Normalization}
...
\end{v3topic}
\begin{v3topic}{Data Augmentation}
...
\begin{v3topic}{Attention: Why It Matters}
...
\end{v3topic}
\begin{v3topic}{Scaled Dot-Product Attention}
...
\end{v3topic}
\begin{v3topic}{Self- and Cross-Attention}
...
\end{v3topic}
\begin{v3topic}{Multi-Head Attention}
...
\begin{v3topic}{Why Transformers Replaced RNNs}
...
\end{v3topic}
\begin{v3topic}{Encoder--Decoder Structure}
...
\end{v3topic}
\begin{v3topic}{Transformer Block Diagram}
...
\end{v3topic}
\begin{v3topic}{Positional Encoding}
...
\end{v3topic}
\begin{v3topic}{GPT and BERT: Decoder- and Encoder-Only}
...
\begin{v3topic}{The Weight Transport Problem}
...
\end{v3topic}
\begin{v3topic}{Feedback Alignment}
...
\begin{v3topic}{Decoupled Neural Interfaces}
...
\begin{v3topic}{Local Learning Signals}
...
\begin{v3topic}{Generator and Discriminator}
...
\end{v3topic}
\begin{v3topic}{The Minimax Objective}
...
\end{v3topic}
\begin{v3topic}{Training Dynamics and Mode Collapse}
...
\begin{v3topic}{Encoder--Bottleneck--Decoder}
...
\end{v3topic}
\begin{v3topic}{Variational Autoencoder (VAE)}
...
\begin{v3topic}{Energy-Based Generative Model}
...
\end{v3topic}
\begin{v3topic}{Contrastive Divergence Training}
...
\begin{v3topic}{Capsules and Dynamic Routing}
...
\begin{v3topic}{Third-Generation Neural Networks}
...
\begin{v3topic}{Residual Pre-Norm Blocks}
...
\end{v3topic}
\begin{v3topic}{Training Parallelism vs Inference}
...
\end{v3topic}
\begin{v3topic}{Efficiency Is Multi-Dimensional}
...
\begin{v3topic}{Recommended Sources for Deep Learning}
    \begin{itemize}
