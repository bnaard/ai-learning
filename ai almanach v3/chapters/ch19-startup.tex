...
\end{equation}
\where{$n$ is the number of model calls per attempt, $c$ the cost of one call, and
$p$ the probability an attempt succeeds. Dividing by $p$ is the step teams
forget: failed attempts are paid for too.}
