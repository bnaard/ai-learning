...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \begin{tblr}{|Q[c,m,4cm]|X|}
        ...
        \hline
    \end{tblr}
\captionof{table}{Introduction to FinTech: The FinTech Ecosystem.}
\label{tab:ch10-fintech-inline-01}
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \begin{tblr}{|Q[c,m]|X|}
        ...
        \hline
    \end{tblr}
\captionof{table}{FinTech Underlying Technologies: ML and DL in Finance.}
\label{tab:ch10-fintech-inline-02}
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \begin{tblr}{|Q[c,m]|X|}
        ...
        \hline
    \end{tblr}
\captionof{table}{Algorithmic Trading: Strategy Types.}
\label{tab:ch10-fintech-inline-03}
    ...
    \begin{tblr}{|X|X|X|}
        ...
        \hline
    \end{tblr}
\captionof{table}{Algorithmic Trading: Backtesting and Overfitting Risk.}
\label{tab:ch10-fintech-inline-04}
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \begin{tblr}{|Q[c,m]|X|X|}
        ...
        \hline
    \end{tblr}
\captionof{table}{Definition and Types of Robo-Advisors: Pure vs.\ Hybrid Robo-Advisors.}
\label{tab:ch10-fintech-inline-05}
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \begin{tblr}{|Q[c,m]|X|}
        ...
        \hline
    \end{tblr}
\captionof{table}{Regulation of AI in Financial Services: Regulation of Robo-Advisors.}
\label{tab:ch10-fintech-inline-06}
