...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Data Structures: Lists, Tuples, Dicts, Sets}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Defining Functions}, raster multicolumn=3]
    ...
    \tcbitem[title={Higher-Order Functions}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Flow Control and Comprehensions}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={File Handling and I/O}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Modules and the Import System}, raster multicolumn=3]
    ...
    \tcbitem[title={Package Management with pip}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={The LEGB Rule}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Classes and Inheritance}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Iterators and Generators}, raster multicolumn=3]
    ...
    \tcbitem[title={Protocol Dunder Methods}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Syntax vs.\ Runtime Errors}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={try / except / finally}, raster multicolumn=3]
    ...
    \tcbitem[title={Context Managers as Error Guards}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Custom Exception Classes}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Python Standard Library Highlights}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={NumPy and SciPy}, raster multicolumn=3]
    ...
    \tcbitem[title={Performance: Memory Layout and ufuncs}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Accelerating Python Code}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Python Visualization Ecosystem}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Database Access in Python}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Virtual Environments}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Reproducible Package Management}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Testing with pytest}, raster multicolumn=3]
    ...
    \tcbitem[title={Test Design Principles}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Docstrings and Type Hints}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Why Version Control?}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Core Git Concepts}, raster multicolumn=3]
...
\label{tab:ch03-programming-foundations-inline-18}
    ...
    \tcbitem[title={Collaboration Workflow}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={The NumPy ndarray}, raster multicolumn=3]
    ...
    \tcbitem[title={Array dtypes}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Indexing and Slicing}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Vectorised Operations and ufuncs}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Broadcasting Rules}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Series and DataFrames}, raster multicolumn=3]
    ...
    \tcbitem[title={Reading and Writing Data}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={loc, iloc, and Boolean Indexing}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Handling Missing Data}, raster multicolumn=3]
    ...
    \tcbitem[title={Type Conversion and Duplicates}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={GroupBy and Aggregation}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Plotting with Pandas}, raster multicolumn=3]
    ...
    \tcbitem[title={Customizing Plots}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Date and Time in Pandas}, raster multicolumn=3]
    ...
    \tcbitem[title={Resampling and Frequency Conversion}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Merging and Joining DataFrames}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Pivot Tables and Cross-Tabulations}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Efficient Pandas Operations}, raster multicolumn=3]
    ...
    \tcbitem[title={Memory Management}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Scikit-learn: Estimator API}, raster multicolumn=3]
    ...
    \tcbitem[title={Scikit-learn: Key Modules}, raster multicolumn=3]
...
\label{tab:ch03-programming-foundations-inline-28}
    ...
    \tcbitem[title={Scikit-learn Pipeline}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={PyTorch Tensors}, raster multicolumn=3]
    ...
    \tcbitem[title={Autograd and the Computation Graph}, raster multicolumn=3]
    ...
    \tcbitem[title={nn.Module and the Training Loop}, raster multicolumn=6]
