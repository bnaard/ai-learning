...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Supply Chain vs.\ Supply Network, raster multicolumn=3]
    ...
    \tcbitem[title=SCOR Reference Model, raster multicolumn=3]
    ...
    \tcbitem[title=The Bullwhip Effect, raster multicolumn=6]
    ...
    \tcblower
    \textbf{AI mitigation}: sharing point-of-sale data across tiers (information sharing), ML-based collaborative forecasting, and automated replenishment systems reduce information delays and amplification at each stage.
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title={Supply Chain 4.0: Digital Transformation}, raster multicolumn=3]
    ...
    \tcbitem[title=Blockchain for Traceability, raster multicolumn=3]
    ...
    \tcbitem[title=Digital Twins in Supply Chains, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=AI Technique Overview, raster multicolumn=6]
    \begin{tblr}{width=\linewidth,colspec={Q[l,m,3cm]X X},hlines,vlines}
        ...
        \hline
    \end{tblr}
\captionof{table}{AI Techniques for Supply Chains: AI Technique Overview.}
\label{tab:ch14-supply-chain-inline-01}
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Exponential Smoothing (SES), raster multicolumn=3]
    ...
    \tcbitem[title=Holt-Winters / ETS, raster multicolumn=3]
    ...
    \tcbitem[title=ARIMA Models, raster multicolumn=3]
    ...
    \tcbitem[title=State-Space and Bayesian Structural Time Series, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=LSTMs for Time Series, raster multicolumn=3]
    ...
    \tcbitem[title=Gradient Boosting for Forecasting, raster multicolumn=3]
    ...
    \tcbitem[title=Temporal Fusion Transformer (TFT), raster multicolumn=3]
    ...
    \tcbitem[title=Probabilistic Forecasting, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Classic Single-Period Newsvendor, raster multicolumn=3]
    ...
    \tcbitem[title=Demand Models and Censoring, raster multicolumn=3]
    ...
    \tcbitem[title=Data-Driven Newsvendor (Ban \& Rudin), raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Harris EOQ Formula, raster multicolumn=3]
    ...
    \tcbitem[title=EOQ Assumptions and Extensions, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title={Continuous Review $(s{,}Q)$ Policy}, raster multicolumn=3]
    ...
    \tcbitem[title={Periodic Review $(s{,}S)$ Policy}, raster multicolumn=3]
    ...
    \tcbitem[title=Service Levels and Safety Stock, raster multicolumn=6]
    ...
    \end{tblr}
\captionof{table}{Inventory Policies and Service Levels: Service Levels and Safety Stock.}
\label{tab:ch14-supply-chain-inline-02}
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Perishable Inventory, raster multicolumn=3]
    ...
    \tcbitem[title=Minimum Order Quantities and Multi-Echelon, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Facility Location Problem, raster multicolumn=3]
    ...
    \tcbitem[title=Scenario Planning and Resilience, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Multi-Criteria Supplier Scoring, raster multicolumn=3]
    ...
    \tcbitem[title=Spend Analytics, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title={Vehicle Routing Problem (VRP)}, raster multicolumn=3]
    ...
    \tcbitem[title=Dynamic Routing with Reinforcement Learning, raster multicolumn=3]
    ...
    \tcbitem[title=Last-Mile Delivery, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=The S\&OP Process, raster multicolumn=3]
    ...
    \tcbitem[title=AI in S\&OP, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Real-Time Tracking and Order Prediction, raster multicolumn=3]
    ...
    \tcbitem[title=Customer and Churn Analytics, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Anomaly Detection in Procurement, raster multicolumn=3]
    ...
    \tcbitem[title=Counterfeit Detection and Supply Chain Security, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Data Quality and Organisational Challenges, raster multicolumn=3]
    ...
    \tcbitem[title={Trust, Accountability, and Accessibility}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title=Recommended Sources for AI in Supply Chain Management, raster multicolumn=6]
    \begin{itemize}
