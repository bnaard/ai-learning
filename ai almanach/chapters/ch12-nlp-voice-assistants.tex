...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title={Core Challenges in NLP}, raster multicolumn=3]
    ...
    \tcbitem[title={A Brief History of NLP}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Levels of Linguistic Analysis}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Tokens: The Atoms of Language}, raster multicolumn=3]
    ...
    \tcbitem[title={The Tokenization Pipeline}, raster multicolumn=3]
    ...
    \tcbitem[title={Byte Pair Encoding (BPE)}, raster multicolumn=3]
    ...
    \tcbitem[title={Why Subword Tokenization Dominates}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Automatic NLP Metrics}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Classical Text Representations}, raster multicolumn=3]
    ...
    \tcbitem[title={Word2Vec: Learning Dense Embeddings}, raster multicolumn=3]
    ...
    \tcbitem[title={GloVe and the Embedding Geometry}, raster multicolumn=3]
    ...
    \tcbitem[title={Contextual Embeddings}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={N-gram Language Models}, raster multicolumn=3]
    ...
    \tcbitem[title={Sequence Models: HMM and CRF}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Seq2Seq: Encoder-Decoder for NLP}, raster multicolumn=3]
    ...
    \tcbitem[title={Attention in RNNs}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={The Transformer for NLP}, raster multicolumn=3]
    ...
    \tcbitem[title={BERT: Pre-training for NLU}, raster multicolumn=3]
    ...
    \tcbitem[title={GPT: Pre-training for Generation}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Classical ASR Pipeline}, raster multicolumn=3]
    ...
    \tcbitem[title={End-to-End ASR: Whisper}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Classical and Neural TTS}, raster multicolumn=3]
    ...
    \tcbitem[title={Neural TTS: WaveNet and Tacotron}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Pre-training Objectives, raster multicolumn=3]
    ...
    \tcbitem[title=Transfer Learning, raster multicolumn=3]
    ...
    \tcbitem[title={Pre-training vs.\ Fine-tuning vs.\ Prompting}, raster multicolumn=6]
    \begin{tblr}{
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title={BERT Architecture}, raster multicolumn=3]
...
\label{tab:ch12-nlp-voice-assistants-inline-05}
    ...
    \tcbitem[title={Pre-training: MLM and NSP}, raster multicolumn=3]
    ...
    \tcbitem[title={Fine-tuning BERT for Downstream Tasks}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=GPT: Decoder-Only Architecture, raster multicolumn=3]
    ...
    \tcbitem[title={GPT Evolution and Scaling Laws}, raster multicolumn=3]
    \begin{tblr}{
        colspec={X[l] X[l] X[l]},
        hlines, vlines,
        row{1}={font=\bfseries\scriptsize, bg=LimeGreen!20},
...
\label{tab:ch12-nlp-voice-assistants-inline-07}
    ...
    \textbf{Scaling laws} (Kaplan et al.\ 2020): model performance improves
    predictably as a power law with (i) number of parameters, (ii) training compute, and
    (iii) dataset size. ``Bigger is better'' largely replaced careful architectural
    engineering.\textsuperscript{\cite[][p.~10]{farrisHowLargeLanguage2025}}

    \tcbitem[title={Emergent Abilities of Large Models}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title={Prompting Strategies}, raster multicolumn=3]
    ...
    \tcbitem[title={System Prompts and Prompt Templates}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title={RAG: Motivation and Pipeline}, raster multicolumn=6]
    ...
    \tcbitem[title={Vector Databases and Chunking}, raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Machine Translation, raster multicolumn=3]
    ...
    \tcbitem[title=Sequence-to-Sequence with Attention, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title={Named Entity Recognition and Sentiment Analysis}, raster multicolumn=3]
    ...
    \tcbitem[title={Text Summarisation and Question Answering}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Task-Oriented Dialogue Systems, raster multicolumn=3]
    ...
    \tcbitem[title={Open-Domain and LLM-Based Assistants}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=NLP Applications in Education, raster multicolumn=3]
    ...
    \tcbitem[title=LLMs as Educational Assistants, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Text Simplification, raster multicolumn=3]
    ...
    \tcbitem[title={Captioning and Speech Accessibility}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Training Data Bias, raster multicolumn=3]
    ...
    \tcbitem[title={Fairness and Debiasing}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Multilingual Models, raster multicolumn=3]
    ...
    \tcbitem[title={Domain Shift and Low-Resource Adaptation}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Hallucination in LLMs, raster multicolumn=3]
    ...
    \tcbitem[title={Alignment and RLHF}, raster multicolumn=3]
...
\begin{tcbitemize}[ skin=sectionraster ]
    ...
    \tcbitem[title=Recommended Sources for NLP and Generative AI, raster multicolumn=6]
    \begin{itemize}
