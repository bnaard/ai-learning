...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Bagging and the Random Forest Algorithm},
    ...
    \tcbitem[title={Out-of-Bag Error and Feature Importance},
             raster multicolumn=6]
...
\begin{tcbitemize}[ skin=sectionraster ]
    \tcbitem[title={Gradient Boosting: Sequential Error Correction},
             raster multicolumn=6]
