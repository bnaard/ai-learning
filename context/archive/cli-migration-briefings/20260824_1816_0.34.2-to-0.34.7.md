...
**Status:** pending
**aibox CLI:** v0.34.2 → v0.34.7
**processkit:** v0.28.8

## Summary

aibox has been updated from v0.34.2 to v0.34.7. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.34.2 and v0.34.7 is listed below.                  Review each; treat entries tagged as breaking as action items.
