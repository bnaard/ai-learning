...
# render pass.
set -g window-style "bg=#171B21,fg=#A4A4A3"
set -g window-active-style "bg=#0A0E14,fg=#B3B1AD"
set -g pane-border-style "fg=#757C84,bg=#0A0E14"
set -g pane-active-border-style "fg=#39BAE6,bg=#0A0E14"
set -g pane-border-indicators both
set -g pane-border-format "#[bg=#0A0E14]#{?pane_active,#[fg=#39BAE6]#[bold],#[fg=#A4A4A3]#[dim] } #{?client_prefix,PREFIX,NORMAL} #{pane_title} #{pane_current_command} #[bg=#0A0E14,fg=#0A0E14] "
