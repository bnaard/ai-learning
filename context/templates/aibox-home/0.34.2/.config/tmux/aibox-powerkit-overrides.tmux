...
# render pass.
set -g pane-border-style "fg=#786B5F,bg=#FBF1C7"
set -g pane-active-border-style "fg=#AF3A03,bg=#FBF1C7"
set -g pane-border-indicators both
set -g pane-border-format "#[bg=#FBF1C7]#{?pane_active,#[fg=#AF3A03]#[bold],#[fg=#4B4540]#[dim] } #{?client_prefix,PREFIX,NORMAL} #{pane_title} #{pane_current_command} #[bg=#FBF1C7,fg=#FBF1C7] "
