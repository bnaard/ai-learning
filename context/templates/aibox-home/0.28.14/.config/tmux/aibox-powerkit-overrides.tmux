...
# render pass.
set -g pane-border-style "fg=#928374,bg=#FBF1C7"
set -g pane-active-border-style "fg=#D65D0E,bg=#FBF1C7"
set -g pane-border-format "#[bg=#FBF1C7]#{?pane_active,#[fg=#BE5714]#[bold],#[fg=#675D55]} #{?client_prefix,PREFIX,NORMAL} #{pane_title} #{pane_current_command} #[bg=#FBF1C7,fg=#FBF1C7] "
